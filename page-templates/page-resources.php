...
<div class="accordion" data-accordion data-multi-expand="false" data-allow-all-closed="true" data-deep-link="true" data-deep-link-smudge="true" data-update-history="true" >
	...
	<h2 class="category-name"><?php the_sub_field('category_name'); ?></h2>
		...
		// loop through the rows of data
			while ( have_rows('sub_category_repeater') ) : the_row(); ?>
				...
				<div class="accordion" data-accordion data-multi-expand="false" data-allow-all-closed="true" data-deep-link="true" data-deep-link-smudge="true" >
					<div class="accordion-item" data-accordion-item>
