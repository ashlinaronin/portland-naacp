...
if ( ! function_exists( 'foundationpress_scripts' ) ) :
	function foundationpress_scripts() {
		...
		// Get version number from theme (style.css) so we can append it to the query string for client cache busting
		define('MY_THEME_VERSION', wp_get_theme()->get('Version'));


		// Enqueue the main Stylesheet.
		wp_enqueue_style( 'main-stylesheet', get_template_directory_uri() . '/dist/assets/css/app.css', array(), MY_THEME_VERSION, 'all' );
